...
const Workout = () => {
  ...
  return (
    <>
    <div id='#workout' className='bg-customBackground'>
        {/* Title */}
        <h1 className='font-bold text-4xl sm:text-5xl md:text-7xl text-center pt-2 text-stone-800'>Workout Plans</h1>
        <p className='text-5xl text-center mt-[30px] underline text-customColor'>Choose your plan</p>
        <p className='text-4xl text-center mt-[50px] font-bold text-amber-950'>Bodybuilding</p>
        ...
        <div className='max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6 '>
          ...
          <div className='rounded-xl relative'>
            {/* Overlay */}
            <Link to='/bro'>
              <div className='absolute w-full h-full bg-black/50 rounded-xl text-stone-300 flex flex-col justify-center'>
        ...
        <p className='text-4xl text-center font-bold text-amber-950 mt-16'>Cardio</p>
        ...
        <div className='max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6'>
          ...
          <div className='rounded-xl relative'>
            ...
            <img className='max-[160px] md:max-h-[250px] h-[320px] w-full object-cover rounded-xl' src="https://images.pexels.com/photos/6039243/pexels-photo-6039243.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
          </div>
          {/*Third card */}
          <div className='rounded-xl relative'>
            {/* Overlay */}
